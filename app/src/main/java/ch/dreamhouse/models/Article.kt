 ...
 * @property advertisementId Article ID
 ...
 */
data class Article(val advertisementId: Long, val title: String, val street:String, val zip:String, val city:String, val price: Int, val currency: String, val pictures: List<String>)